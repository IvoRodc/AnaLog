...
public class ExposicaoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       Toolbar.setNavigationOnClickListener(new View.OnClickListener() {
        ...
        recyclerView.setPadding(0,(int)Math.round((actionBarHeight*2)+(actionBarHeight*0.47)),0,actionBarHeight);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(this,RolosActivity.class);
    ...
    public void onClickDialogCam(View view){
        ...
        try {
            ...
            Log.e("DEBUG:", "Sem Cameras na lista");
        return;
        }
        ...
        ad.setSingleChoiceItems(CameraNames.toArray(new String[CameraNames.size()]), -1, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                ((TextInputEditText)v.findViewById(R.id.IDCAM_Edt_Rolo)).setText(CameraNames.get(which));
                dialog.dismiss();
            }
        });
        ad.show();
