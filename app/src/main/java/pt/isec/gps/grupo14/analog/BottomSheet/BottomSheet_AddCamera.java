...
public class BottomSheet_AddCamera extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.bottom_sheet_add_camera, container, false);
        Button button = v.findViewById(R.id.btn_new_Camera);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Camera c = new Camera(marca.getText().toString(), modelo.getText().toString(), getContext());

                marca.setText("");
                modelo.setText("");

                dismiss();
                ((ListaCamerasAdapter)((RecyclerView)(getActivity().findViewById(R.id.lista_cameras))).getAdapter()).addNewCamera(c);
            }
        });
